// ALIVE Clean Deploy - Fixed Version
console.log('🧬 ALIVE SYSTEM - DEPLOYING...');

const fs = require('fs');
const path = require('path');

// Simple deployment without template literal errors
function createALIVESystem() {
    // Create main directory
    if (!fs.existsSync('alive-system')) {
        fs.mkdirSync('alive-system');
    }
    ...
    const packageJson = {
        "name": "alive-system",
        "version": "1.0.0",
        "description": "ALIVE Bot System with GUI",
        "main": "server.js",
        "scripts": {
    ...
    fs.writeFileSync('alive-system/package.json', JSON.stringify(packageJson, null, 2));
...
server.start();`;
    ...
    fs.writeFileSync('alive-system/server.js', serverCode);
    console.log('✅ Created server.js with GUI');

    console.log('\n🎉 ALIVE SYSTEM DEPLOYED SUCCESSFULLY!');
    console.log('📋 Next steps:');
    console.log('   cd alive-system');
